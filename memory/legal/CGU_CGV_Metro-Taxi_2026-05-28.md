...
L'accès au Service est subordonné à l'acceptation expresse et sans réserve des présentes CGU/CGV, matérialisée par le cochage de la case dédiée lors de la création du compte.

---

## ARTICLE 1 — DÉFINITIONS

Dans les présentes CGU/CGV, les termes commençant par une majuscule ont la signification qui leur est donnée ci-dessous :

- **Abonné** : Utilisateur ayant souscrit un abonnement actif (24 heures, 7 jours ou mensuel) lui permettant de bénéficier des services de transport offerts par la Plateforme.
- **Application** : application web progressive (PWA) accessible à l'adresse https://metro-taxi.com.
- **Chauffeur Indépendant** : prestataire travailleur indépendant, titulaire d'une carte professionnelle VTC en cours de validité, ayant adhéré au Contrat de Partenariat Chauffeur Métro-Taxi.
- **Chauffeur Initial** : le Chauffeur Indépendant prenant en charge le ou les Abonnés au point de départ du trajet.
- **Chauffeur de Relais** (ou "Chauffeur Receveur") : le Chauffeur Indépendant prenant en relais le ou les Abonnés lors d'une opération de transbordement en cours de trajet.
...
Métro-Taxi est une **plateforme technologique de mise en relation** entre Abonnés et Chauffeurs Indépendants. La Plateforme n'est **pas un transporteur** au sens du Code des transports et n'effectue elle-même aucune prestation de transport.

Les prestations de transport sont exclusivement exécutées par les Chauffeurs Indépendants, agissant en qualité de **travailleurs indépendants** au sens du Code du travail et bénéficiant d'une totale liberté contractuelle et commerciale.

### 2.2 Caractère spécifique : covoiturage à transbordement intelligent
...
Le Service est **exclusivement réservé** aux Utilisateurs ayant souscrit un abonnement actif et valide auprès de la Plateforme. **Aucun trajet ne peut être effectué pour un Utilisateur non Abonné, ni pour un accompagnant non Abonné individuellement à la Plateforme.**
...
- Disposant de la pleine capacité juridique ;
- Disposant d'une adresse e-mail valide et d'un numéro de téléphone mobile français ou européen.

### 3.2 Informations obligatoires

L'Utilisateur s'engage à fournir des informations exactes, complètes et à jour : nom, prénom, adresse postale complète (rue, code postal, ville), date de naissance, e-mail, téléphone.

Toute information inexacte, incomplète ou frauduleuse pourra entraîner la suspension ou la résiliation immédiate du compte, sans préavis ni indemnité, conformément à l'article 12 des présentes.

### 3.3 Vérification de l'identité

La Plateforme se réserve le droit de demander à tout moment la transmission d'un document d'identité officiel en cours de validité pour confirmer l'identité de l'Utilisateur.
...
La Plateforme propose les abonnements suivants, payables en ligne par carte bancaire via le prestataire de paiement **Sogecommerce** (Société Générale) :

| Formule | Durée | Tarif TTC | Plafonds d'usage |
|---|---|---|---|
| 24 heures | 24 h consécutives | **6,99 €** | 5 trajets max |
| 7 jours | 168 h consécutives | **19,99 €** | 15 trajets max, 3 trajets/jour max |
| Mensuel | 30 jours calendaires | **53,99 €** | Usage raisonnable selon politique fair-use |

### 4.2 Activation de l'abonnement

L'abonnement est activé immédiatement après confirmation du paiement par Sogecommerce. Sa durée court à compter de la date et heure d'activation et expire automatiquement à la fin de la période souscrite.

### 4.3 Renouvellement

L'abonnement **n'est pas reconductible tacitement**. L'Abonné doit souscrire un nouvel abonnement pour bénéficier à nouveau du Service.

### 4.4 Droit de rétractation

Conformément à l'article L. 221-28 du Code de la consommation, le droit de rétractation est **inapplicable** dès lors que la prestation de service a commencé, ce que l'Abonné reconnaît expressément en activant son abonnement.

---

## ARTICLE 5 — CRÉDIT COURSE OFFERTE (CAMPAGNES DE LANCEMENT)

### 5.1 Attribution automatique

La Plateforme peut périodiquement organiser des campagnes de lancement attribuant un **Crédit Course Offerte** aux N premiers Abonnés d'une zone géographique. L'attribution est réalisée **automatiquement par l'Algorithme** au moment de l'activation de l'abonnement, **selon le principe du "premier abonné, premier servi"**, sans intervention humaine et de manière strictement non-discrétionnaire.

### 5.2 Caractéristiques du Crédit Course Offerte

- **Bénéfice** : une (1) course gratuite plafonnée à dix (10) kilomètres maximum ;
- **Quota** : 30 places par campagne (Saint-Denis 13 juin 2026), non-renouvelable ;
- **Date d'ouverture** : le Crédit est **consommable à partir du samedi 13 juin 2026 à 00h00** (heure de Paris) ;
- **Date d'expiration** : le Crédit expire le 30 juin 2026 à 23h59 (heure de Paris) ;
- **Usage unique** : un (1) Abonné = un (1) Crédit, **non-cumulable et non-cessible**.

### 5.3 Conditions de consommation
...
## ARTICLE 6 — CONDITIONS D'EMBARQUEMENT, DE TRANSBORDEMENT ET DE VALIDATION CONTINUE

### 6.1 Service réservé aux Abonnés

Métro-Taxi est un service de **covoiturage à transbordement intelligent réservé EXCLUSIVEMENT aux Abonnés** disposant d'un abonnement actif (formule 24 heures, 7 jours ou mensuelle).
...
Lors d'un transbordement en cours de trajet, l'Algorithme Métro-Taxi procède automatiquement à une **revalidation algorithmique continue** auprès du **Chauffeur de Relais** (également dénommé "Chauffeur Receveur"). Cette revalidation vérifie que :
- Chaque Abonné transbordé dispose toujours d'un abonnement actif et non expiré ;
- La couverture financière du **segment de trajet restant** est garantie ;
- Le Chauffeur de Relais n'embarquera que des Abonnés validés algorithmiquement.
...
Les Chauffeurs Indépendants reçoivent de la Plateforme **uniquement les informations strictement nécessaires** à l'exécution technique du trajet :
- Point de prise en charge et point de dépose ;
- Nombre de passagers validés algorithmiquement ;
- Itinéraire indicatif optimisé.

**La Plateforme n'exerce aucun pouvoir de direction, de contrôle ou de sanction** sur les Chauffeurs Indépendants, qui demeurent libres d'accepter ou de refuser toute course **sans pénalité ni justification**.
...
Sauf application du Crédit Course Offerte (article 5), **toutes les courses sont incluses dans l'abonnement actif de l'Abonné**, dans la limite des plafonds définis à l'article 4.1.

### 8.2 Dépassement de plafond
...
- Identité et coordonnées (nom, prénom, e-mail, téléphone, adresse) ;
- Données de localisation (au moment de la réservation et pendant la course) ;
- Données de paiement (tokenisées via Sogecommerce, jamais conservées en clair par la Plateforme) ;
...
- Compte actif : durée de la relation contractuelle + 3 ans après la dernière course ;
- Données comptables : 10 ans (obligation légale) ;
- Données de paiement : non conservées en clair par la Plateforme.
...
L'usage de cookies sur le site est limité aux cookies strictement nécessaires au fonctionnement du Service (session, panier). Aucun cookie publicitaire ou tiers n'est déposé sans consentement explicite.
...
Chaque Chauffeur Indépendant est seul responsable de :
- L'exécution conforme de la course ;
- Le respect du Code de la route et du Code des transports ;
- La validité de son assurance professionnelle ;
- La validité de sa carte VTC.

### 10.3 Responsabilité des Abonnés

Chaque Abonné est responsable :
- De la véracité des informations fournies lors de l'inscription ;
- Du respect des règles d'embarquement (article 6) ;
- De son comportement à bord et envers les autres passagers ;
- De la confidentialité de ses codes OTP de démarrage de course.

---

## ARTICLE 11 — FRAUDE ET SANCTIONS

### 11.1 Définition de la fraude

Constitue notamment une fraude :
- L'inscription avec de fausses informations d'identité ;
- La tentative d'embarquement d'un passager non Abonné ;
- Le partage du compte Abonné avec un tiers ;
- La revente non autorisée d'un Crédit Course Offerte ;
- Toute manœuvre visant à contourner les vérifications algorithmiques.

### 11.2 Sanctions progressives par la Plateforme

En cas de fraude détectée par l'Algorithme ou signalée par un Chauffeur Indépendant via le système prévu à cet effet :
- **1<sup>ère</sup> tentative** : avertissement par e-mail ;
- **2<sup>ème</sup> tentative** : suspension du compte pendant 7 jours ;
- **3<sup>ème</sup> tentative** : résiliation définitive du compte, **avec conservation par la Plateforme des sommes déjà versées** au titre de l'abonnement et du Crédit Course Offerte, à titre d'indemnité conventionnelle forfaitaire.

### 11.3 Sanction exclusivement plateforme

Les sanctions ci-dessus sont **prises exclusivement par la Plateforme** dans le cadre de sa liberté contractuelle vis-à-vis de ses Abonnés. **Les Chauffeurs Indépendants n'exercent aucun pouvoir de sanction** et ne subissent aucune incidence financière liée aux sanctions prononcées par la Plateforme.
...
Les présentes CGU/CGV sont conclues pour une durée indéterminée à compter de l'acceptation par l'Utilisateur.

### 12.2 Résiliation par l'Utilisateur

L'Utilisateur peut résilier son compte à tout moment par e-mail à contact@metro-taxi.com. La résiliation est effective sous 7 jours ouvrés. Les abonnements en cours ne donnent pas lieu à remboursement (cf. article 4.4).

### 12.3 Résiliation par la Plateforme

La Plateforme peut résilier le compte d'un Utilisateur :
- En cas de fraude (article 11) ;
- En cas de violation grave et répétée des présentes CGU/CGV ;
- En cas de cessation du Service (avec préavis de 30 jours et remboursement prorata temporis des abonnements en cours).

---

## ARTICLE 13 — MODIFICATION DES CGU/CGV

La Plateforme se réserve le droit de modifier les présentes CGU/CGV à tout moment. Les modifications sont notifiées par e-mail aux Utilisateurs avec un préavis de 15 jours. L'Utilisateur dispose d'un droit de résiliation sans pénalité en cas de désaccord avec les nouvelles conditions.
...
Les présentes CGU/CGV constituent l'intégralité de l'accord entre les Parties.

### 15.2 Nullité partielle

Si une clause venait à être déclarée nulle ou inapplicable, les autres clauses conserveront leur pleine validité.
