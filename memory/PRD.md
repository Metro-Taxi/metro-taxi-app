...
- [x] **Nettoyage des 16 scripts vocaux TTS** (`/app/backend/routes/tts.py`)
  - Suppression des termes "transbordement / transfer / overstap / övergång / overgang / 换乘 / ट्रांसफर / ਟ੍ਰਾਂਸਫਰ / التحويل" dans 8 langues (nl, no, sv, da, zh, hi, pa, ar)
  - Tous les scripts utilisent désormais "connexions/correspondances optimisées" ou équivalent neutre
  - Cache audio local vidé + voix FR re-générée et validée (HTTP 200, 811 KB)
