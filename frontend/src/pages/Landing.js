        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex justify-center gap-4 flex-wrap">
              <span className="px-4 py-2 bg-[#FFD60A] text-black font-bold rounded-full flex items-center gap-2">
                🇫🇷 {t('pricing.regions.paris', 'Île-de-France')}
              </span>
              <span className="px-4 py-2 bg-zinc-800 text-zinc-400 font-medium rounded-full flex items-center gap-2 opacity-70">
                🇪🇸 {t('pricing.regions.madrid', 'Madrid')} <span className="text-xs">({t('pricing.comingSoon', 'Bientôt')})</span>
              </span>
              <span className="px-4 py-2 bg-zinc-800 text-zinc-400 font-medium rounded-full flex items-center gap-2 opacity-70">
                🇬🇧 {t('pricing.regions.london', 'Londres')} <span className="text-xs">({t('pricing.comingSoon', 'Bientôt')})</span>
              </span>
            </div>
          </div>
          ...
          >
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-xl font-bold text-white">{t('pricing.zones.madrid.title', 'Madrid')}</h4>
                <span className="text-zinc-500 text-sm">({t('pricing.comingSoon', 'Bientôt disponible')})</span>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                {/* Zone A */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.madrid.zoneA.name', 'Zone A')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.madrid.zoneA.desc', 'Madrid Centro, Alcorcón, Getafe, Leganés')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.day', '24h')}</span><span className="font-bold text-[#FFD60A]">€4.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.week', '1 Sem.')}</span><span className="font-bold text-[#FFD60A]">€12.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                ...
                {/* Zones B1-B2 */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.madrid.zoneB.name', 'Zones B1-B2')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.madrid.zoneB.desc', 'Móstoles, Fuenlabrada, Parla, Arganda')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
                ...
                {/* Zones B3/C1/C2 */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.madrid.zoneC.name', 'Zones B3/C1/C2')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.madrid.zoneC.desc', 'Alcalá de Henares, Torrejón de Ardoz')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="text-3xl">🇬🇧</span>
                <h4 className="text-xl font-bold text-white">{t('pricing.zones.london.title', 'London')}</h4>
                <span className="text-zinc-500 text-sm">({t('pricing.comingSoon', 'Bientôt disponible')})</span>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                {/* Zones 1-2 */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.london.zone12.name', 'Zones 1-2')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.london.zone12.desc', 'Central London, Camden, Greenwich')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.day', '24h')}</span><span className="font-bold text-[#FFD60A]">£9.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.week', '1 Week')}</span><span className="font-bold text-[#FFD60A]">£29.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                ...
                {/* Zones 1-4 */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.london.zone14.name', 'Zones 1-4')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.london.zone14.desc', '+ Stratford, Wimbledon, Wembley')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.day', '24h')}</span><span className="font-bold text-[#FFD60A]">£14.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.week', '1 Week')}</span><span className="font-bold text-[#FFD60A]">£44.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                ...
                {/* Zones 1-6 */}
                <div className="bg-zinc-800/50 rounded-xl p-4 border border-zinc-700">
                  <p className="text-[#FFD60A] font-bold text-sm mb-3">{t('pricing.zones.london.zone16.name', 'Zones 1-6')}</p>
                  <p className="text-zinc-500 text-xs mb-2">{t('pricing.zones.london.zone16.desc', 'Greater London + Heathrow')}</p>
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.day', '24h')}</span><span className="font-bold text-[#FFD60A]">£19.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
                      <span>{t('pricing.zones.duration.week', '1 Week')}</span><span className="font-bold text-[#FFD60A]">£59.99</span>
                    </div>
                    <div className="flex justify-between text-zinc-300">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 mb-3">
                <div className="flex items-center justify-between">
                  <span className="text-black font-bold flex items-center gap-2">
                    <span className="text-xl">🇫🇷</span> {t('drivers.revenue.byRegion.paris.label')}
                  </span>
                  <div className="text-right">
                    <span className="text-2xl font-black text-black">{t('drivers.revenue.byRegion.paris.rangeMin')} - {t('drivers.revenue.byRegion.paris.rangeMax')}</span>
                    <p className="text-xs text-black/60">{t('drivers.revenue.monthly')} {t('drivers.revenue.launchNote')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 mb-3">
                <div className="flex items-center justify-between">
                  <span className="text-black font-bold flex items-center gap-2">
                    <span className="text-xl">🇪🇸</span> {t('drivers.revenue.byRegion.madrid.label')}
                  </span>
                  <div className="text-right">
                    <span className="text-2xl font-black text-black">{t('drivers.revenue.byRegion.madrid.rangeMin')} - {t('drivers.revenue.byRegion.madrid.rangeMax')}</span>
                    <p className="text-xs text-black/60">{t('drivers.revenue.monthly')} {t('drivers.revenue.launchNote')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 mb-4">
                <div className="flex items-center justify-between">
                  <span className="text-black font-bold flex items-center gap-2">
                    <span className="text-xl">🇬🇧</span> {t('drivers.revenue.byRegion.london.label')}
                  </span>
                  <div className="text-right">
                    <span className="text-2xl font-black text-black">{t('drivers.revenue.byRegion.london.rangeMin')} - {t('drivers.revenue.byRegion.london.rangeMax')}</span>
                    <p className="text-xs text-black/60">{t('drivers.revenue.monthly')} {t('drivers.revenue.launchNote')}</p>
                  </div>
                </div>
              </div>

              {/* Depending + Gross Revenue */}
              <div className="bg-black/10 backdrop-blur-sm rounded-lg p-3 mb-3 text-center">
                <p className="text-xs text-black/70">{t('drivers.revenue.depending')}</p>
                <p className="text-xs text-black/60 mt-1 font-semibold">{t('drivers.revenue.grossRevenue')}</p>
              </div>

              {/* Legal mentions */}
              <div className="bg-black/5 rounded-lg p-4 space-y-1">
                <p className="text-xs text-black/60">{t('drivers.legal.independence')}</p>
                <p className="text-xs text-black/60">{t('drivers.legal.platform')}</p>
                <p className="text-xs text-black/60">{t('drivers.legal.noSubordination')}</p>
                <p className="text-xs text-black/60">{t('drivers.legal.directRelation')}</p>
              </div>
            </motion.div>
